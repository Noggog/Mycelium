...
public class SmartPlaylistServiceTests
{
    ...
    public async Task Creating_a_playlist_describes_it_in_plex()
    {
        ...
        summary.Should().Contain("• Not heard in 1+ years");
        summary.Should().Contain("• Mycelium approved or recommended");
    ...
    public async Task The_description_names_this_users_own_reject_floor()
    {
        ...
        _playlists.Summaries.Should().ContainSingle()
            .Which.Summary.Should().Contain("• Excludes 0.5★ rated songs");
    }
