...
// The app's own moods — the like/dislike verdicts, the "<user>_added" credits and the
// "<user>_recommended" markers — never appear here and can't be edited through it.
...
// a delta in Plex, so the field's other tags (including the app's own hidden moods) are left alone.
